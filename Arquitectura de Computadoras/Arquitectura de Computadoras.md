...
La próxima instrucción se la da al procesador a través del **contador de programas**. Las instrucciones no ocupan todas el mismo espacio en memoria. Es un registro donde figura la dirección de la próxima instrucción, que necesita 16 bits para saber a donde ir.

Luego de una interrupción, usa una pila para volver a lo que estaba haciendo antes de tratar el evento. **STACK POINTER**, pila de estados del procesador.
...
Acumulador A y B: No puede manejar contenido de la memoria si estos datos no están en alguno o en ambos de los acumuladores. Para hacer cualquier operación lógica o matemática los datos tienen que estar en alguno o en los dos.
